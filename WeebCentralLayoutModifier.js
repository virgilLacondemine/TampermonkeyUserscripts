...
function readerHomeBtn()
{
    ...
    readerFooterContainerInsertBtn(homeBtn);
}
...
function readerSubscriptionBtn()
{
    ...
    readerFooterContainerInsertBtn(susbcriptionBtn);
}

/*
 * Helper function to insert a given btn to the reader footer container
 */
function readerFooterContainerInsertBtn(btn)
{
